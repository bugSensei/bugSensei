...
.heading {
    ...
    font-family: "Noto Sans", sans-serif; /* Apply imported font */
    font-weight: 700; /* Adjust font weight if needed */
    color: #fffcf2; /* Optional: Change text color */
...
if prompt := st.chat_input("Type your message here..."):
    ...
    # Uncomment and modify the following when Mistral API is set up
